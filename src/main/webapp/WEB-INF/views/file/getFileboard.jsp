        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-footer">
                    <a href="${path1}/file/filelist1.do" class="btn btn-primary">파일 자료 목록</a>
                    <c:if test="${sid.equals('admin')}">
                        <a href="${path1}/file/removeFileboard.do?postNo=${fileboard.fileBoard.postNo}" class="btn btn-danger">자료 삭제</a>
                        <a href="${path1}/file/modifyFileboard.do?postNo=${fileboard.fileBoard.postNo}" class="btn btn-info">자료 수정</a>
                    </c:if>
                </div>
            </div>
        </div>
